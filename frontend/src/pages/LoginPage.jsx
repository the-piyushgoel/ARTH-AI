    ...
    <div className="min-h-screen bg-animated flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold gradient-text">Welcome to ARTH</h1>
          <p className="text-surface-200/50 mt-2">Sign in to your financial intelligence dashboard</p>
        </div>
